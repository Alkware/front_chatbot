...
export const ListMenuModal = ({ children }: ListMenuModal) => {
    ...
    return (
        <div
            ...
            className="w-full h-[90%] flex flex-col fixed md:static top-0 left-0 z-40 bg-primary-200 md:bg-transparent data-[isopenmobileopen=false]:hidden md:data-[isopenmobileopen]:block" 
        >
            <ul className="w-full flex flex-col">
                {
                    children.map((child: any, index: number) =>
                        <div
                            ...
                            className="w-full text-center data-[isactive=true]:text-light data-[isactive=true]:bg-primary-100 dark:data-[isactive=true]:bg-primary-200 hover:bg-primary-100 hover:text-light dark:hover:bg-primary-300 overflow-hidden px-2 flex justify-start items-center text-base"
                        >
                            <Li
