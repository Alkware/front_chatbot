...
export function ModalCreateProduct({ useFieldArray, useFormReturn, index }: ModalCreateProduct) {
    ...
    return (
        <div
            ref={containerRef}
            className="w-full h-screen flex flex-col justify-start md:justify-center items-center gap-6 py-4 overflow-hidden overflow-y-auto fixed top-0 left-0 z-[999] bg-primary-50 dark:bg-primary-200 rounded-md"
        >
            ...
            <FormProvider {...form}>
                <form
                    ...
                    className="w-full max-w-[1200px] py-8 flex flex-col justify-start items-center gap-6"
                >
