...
export function SimulatorDevice() {
    return (
        <div
            className="group data-[isdesktop=true]:w-[90vw] w-[400px] border-[20px] border-black rounded-[2rem] bg-black"
        >
            <div className="w-full h-full bg-zinc-800 rounded-2xl overflow-hidden flex flex-col gap-1">
                <div
