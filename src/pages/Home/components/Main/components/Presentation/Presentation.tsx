        ...
        >
            <div className="w-full px-4 max-w-[1300px] flex gap-4">
                <div className="w-1/2 flex flex-col gap-4 items-center z-10">
                    ...
                    <h1 className="w-full text-5xl md:text-3xl font-bold uppercase font-sans animate-jump-screen">
                    ...
                    <div className="w-full flex gap-2 items-center">
                        ...
                        <span className="text-3xl md:text-2xl bg-red-500 font-bold rounded-md animate-jump-screen">único link inteligente</span>
                    </div>
                    <h3
                        className="text-xl md:text-lg opacity-70 animate-display-screen"
                    >
