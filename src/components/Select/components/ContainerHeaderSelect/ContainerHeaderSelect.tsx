...
export function ContainerHeaderSelect({ contentOptionsRef, children }: ContainerHeaderSelect) {
    ...
    return (
        <div
            ...
            className="w-full border bg-primary-100/30 dark:bg-gray border-primary-100 group-data-[formerror=true]:border group-data-[formerror=true]:border-red-500 p-2 flex gap-4 justify-between items-center cursor-pointer rounded-md text-primary-100 dark:text-light"
        >
