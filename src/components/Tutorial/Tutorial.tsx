...
const tutorials = [
    {
        ...
        text: `Clique em <div class="inline-block p-1 mx-2 rounded-sm"><div class="w-[20px] h-[20px] flex justify-center items-center overflow-hidden border-2 border-primary-100 rounded-full"><span class="text-light text-3xl">+</span></div></div> para criar seu primeiro chat simples e rápido`,
        positionX: "60vw",
        positionY: "2vh"
    },
    {
