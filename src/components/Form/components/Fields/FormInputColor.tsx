...
export function FormInputColor({ title, joinAtInput,containerWidth, ...props }: FormInputColor) {
    ...
    return (
        ...
        <div
            className={twMerge("flex flex-col items-center gap-2 my-4 relative border border-primary-100 rounded-md", containerWidth)}
            ref={containerRef}
        ...
        >
            ...
            <div className="w-[100px] h-[50px] flex gap-2 justify-center items-center cursor-pointer bg-gray_light px-2">
                <input
                    type="color"
