...
export function Container({ children, title, className }: Container) {
    ...
    return (
        <div
            className={twMerge("w-full h-full flex flex-col gap-4 justify-center items-start bg-light dark:bg-dark rounded-xl border border-primary-300 relative", className)}
        >
