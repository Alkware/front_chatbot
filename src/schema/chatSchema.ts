...
export const chatSchema = z.object({
    ...
    links: z.optional(z.array(z.object({
        ...
        url: z.string().url("1:Informe uma url valída para seu link!"),
        description: z.string().min(1, "1:Informe uma descrição do seu link.")
    }))),
    facebook_pixel: z.coerce.string().optional().nullable(),
    chat_appearance: z.object({
        chat_icon: z.number().min(1, "3:Selecione um icon para o widget do seu chat.").optional(),
        icon_text: z.string().min(1, "3:Informe um texto para o icone do chat.").optional(),
        primary_color: z.string().min(1, "3:Informe um cor primária para seu chat.").optional(),
        second_color: z.string().min(1, "3:Informe uma cor secondária para seu chat.").optional(),
        background: z.string().min(1, "3:Informe uma cor de fundo para seu chat.").optional(),
    }).optional(),
